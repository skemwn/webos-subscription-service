...
function badgeHtml(value) {
    ...
    return `<span class="${badgeClass(text)}">${text}</span>`;
}
...
function renderSubscribers() {
    ...
    filtered.forEach((subscriber) => {
        ...
        tr.innerHTML = `
            ...
            <td>${badgeHtml(subscriber.status)}</td>
...
async function selectDevice(deviceId) {
    ...
    try {
        ...
        usageInfo.innerHTML = `
            ...
            <div class="label">Power Status</div><div class="value">${badgeHtml(data.powerStatus)}</div>
            ...
            <div class="label">Health Status</div><div class="value">${badgeHtml(data.healthStatus)}</div>
